...
public class InvoiceController {
  ...
  public InvoiceController(InvoiceRepository repo, TotalsCalculator totals, ChangeFeedService changes, IdempotencyService idem, NumberingService numbering){
  ...
  public ResponseEntity<List<InvoiceEntity>> listPaged(@RequestParam int page, @RequestParam int size){
  ...
  public ResponseEntity<InvoiceEntity> create(@RequestHeader(value="Idempotency-Key", required=false) String idk,
    ...
    if (i.getNumber()==null || i.getNumber().isBlank()) i.setNumber(numbering.next("INVOICE"));
