...
public class Intervention {
  ...
  public List<BillingLine> getBillingLines(){
    List<BillingLine> list = new ArrayList<>();
    for (BillingLine line : billingLines){
  ...
  public void setBillingLines(List<BillingLine> lines){
    billingLines.clear();
    if (lines == null){
      return;
    }
    for (BillingLine line : lines){
      BillingLine copy = copy(line);
      if (copy != null){
        billingLines.add(copy);
      }
    }
  }

  public Intervention addBillingLine(BillingLine line){
    BillingLine copy = copy(line);
    if (copy != null){
      billingLines.add(copy);
    }
